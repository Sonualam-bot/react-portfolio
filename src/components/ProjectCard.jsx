  ...
  return (
    ...
    >
      <img
        src={img}
        alt="/img"
        className="rounded-xl group-hover:opacity-10 w-full h-full transition ease-in-out duration-1000 "
      />

      <div className="hidden transition ease-in-out duration-1000 group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]  ">
